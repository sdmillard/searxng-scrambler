...
Also I made this on Linux, everything should work except for anything that touches the desktop, so probably not the autostart or the icon installation, but if you're savvy go ahead and try your luck. The one update I do will probably be getting that to happen.
